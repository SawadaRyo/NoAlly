...
public class PlayerContoller : MonoBehaviour
{
    ...
    [SerializeField, Tooltip("Rayの射程")] float distance = 0.1f;//
    ...
    [SerializeField, Tooltip("武器prefabを格納する変数")] GameObject[] m_weaponPrefab = new GameObject[3];
    ...
    void MoveMethod()
    {
        ...
        if (m_h != 0)
        {
            if (Input.GetButton("Dash"))//ダッシュコマンド
            {
